...
document.querySelector('.rating__submissions').addEventListener('mouseover', function(){
...
document.querySelector('.rating__btn').addEventListener('click', function(){
  ...
  document.querySelector('.submitted-state__selection').textContent = `You rated ${clickedRating} out of 5`
  // console.log(`You clicked ${clickedRating}`)
  })
